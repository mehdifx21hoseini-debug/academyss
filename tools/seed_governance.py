...
conflicts = [{
    ...
    "possible_explanation": ("احتمالاً دو موضوع متفاوت‌اند: یکی ساختار حرکت قیمت (اسپایک، کانال، رنج) و "
                             ...
                             "می‌آورد؛ این به نفع تفکیک دو موضوع است، اما تصمیم نهایی با مالک پروژه است."),
    "authority_decision": "",
    "status": "OPEN",
    "requires_human_review": True,
    "review_priority": "P1",
...
review = [
    ...
    rq(15, "تعارض دو فهرست «سه اصل بازار» نیازمند تعیین تکلیف است", "academy",
       ...
       "(ACA-INT-0179) و شاهد تازه‌ای به نفع همین گزینه است.",
       "P1", ["CONF-0002", "ACA-INT-0006", "ACA-INT-0007", "ACA-INT-0179"]),
