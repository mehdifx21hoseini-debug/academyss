...
conflicts = [{
    ...
    "side_b": {
        "object_id_or_source": "MT4-PROC-0009 (دانش پلتفرم)",
    ...
    "requires_human_review": False,
    "review_priority": "P3",
    "impact": ("حل شد. مربی درباره‌ی Open Offline از محتوای دوره چیزی نمی‌گوید؛ تنها رکورد باقی‌مانده "
               "MT4-PROC-0009 در لایه‌ی دانش پلتفرم است که کارکرد واقعی آن را توضیح می‌دهد."),
    "created_at": NOW, "updated_at": NOW,
}]
