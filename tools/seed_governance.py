...
conflicts = [{
    ...
    "possible_explanation": ("احتمالاً ساده‌سازی بیانی در کلاس یا خطای ترنسکریپت است. این مورد یک "
                             "واقعیت فنی پلتفرم است، نه متدولوژی آکادمی؛ بنابراین مرجعیت آکادمی در "
                             "اینجا موضوعیت ندارد و باید با رفتار واقعی متاتریدر سنجیده شود."),
    "authority_decision": "",
    "status": "OPEN",
    "requires_human_review": True,
    "review_priority": "P2",
    "impact": ("تا تعیین تکلیف، مربی نباید به دانشجو بگوید با قطع اینترنت می‌تواند از چارت آفلاین "
               "استفاده کند؛ چون ممکن است دانشجو تصور کند معامله‌اش همچنان مدیریت می‌شود."),
    "created_at": NOW, "updated_at": NOW,
}]
