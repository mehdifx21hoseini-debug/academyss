...
conflicts = [{
    ...
    "possible_explanation": ("به‌احتمال زیاد دو موقعیت متفاوت‌اند: اتصال پلتفرم متاتریدر به سرور بروکر "
                             "نیازی به فیلترشکن ندارد، اما باز کردن وب‌سایت و کابین بروکر ممکن است "
                             "نیاز داشته باشد. تفکیک این دو در پاسخ به دانشجو ضروری است."),
    "authority_decision": "",
    "status": "OPEN",
    "requires_human_review": True,
    "review_priority": "P2",
    "impact": ("پاسخ مربی باید تفکیک کند: برای سایت بروکر ممکن است لازم باشد، برای اتصال متاتریدر خیر. "
               "تا تأیید، هر دو بیان حفظ می‌شوند."),
    "created_at": NOW, "updated_at": NOW,
}]
