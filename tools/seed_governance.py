...
conflicts = [{
    ...
    "possible_explanation": ("احتمالاً دو موضوع متفاوت‌اند: یکی ساختار حرکت قیمت (اسپایک، کانال، رنج) و "
                             ...
                             "می‌آورد، و جلسه‌ی ۱۲ (ACA-INT-0191) همان سه مورد را به‌عنوان «سه چرخه‌ی "
                             "اصلی بازار» با روش معامله‌ی هرکدام تعریف می‌کند. دو شاهد مستقل به نفع "
                             "تفکیک دو موضوع است، اما تصمیم نهایی با مالک پروژه است."),
    "authority_decision": "",
    "status": "OPEN",
    "requires_human_review": True,
    "review_priority": "P1",
...
review = [
    ...
    rq(15, "تعارض دو فهرست «سه اصل بازار» نیازمند تعیین تکلیف است", "academy",
       ...
       "می‌گوید (ACA-INT-0191). با دو شاهد مستقل، گزینه‌ی سوم تقریباً قطعی است و فقط تأیید شما "
       "لازم است.",
