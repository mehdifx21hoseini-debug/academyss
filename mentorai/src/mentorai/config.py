...
class Settings(BaseSettings):
    ...
    #
    # اندازه‌ی پیش‌فرض از روی هزینه‌ی واقعی یک پیام حساب شده: با پرسش و تاریخچه و
    # هشت قطعه‌ی بازیابی‌شده، حدود ۴٬۰۰۰ توکن ورودی و ۵۰۰ توکن خروجی می‌شود، که با
    # قیمت claude-opus-5 حدود ۰٫۰۳۳ دلار است. پس ۵ دلار در روز یعنی حدود ۱۵۰ پیام
    # در روز — برای آزمایش یک‌حسابی با فاصله‌ی زیاد کافی است.
